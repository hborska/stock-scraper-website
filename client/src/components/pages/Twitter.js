...
import TwitterSortDropdown from './twitter/TwitterSortDropdown';
import TwitterTimeFrame from './twitter/TwitterTimeFrame';
...
const Twitter = () => {
  ...
  return (
    <div className='tablePg'>
      ...
      >
        <h2 className='header'>Hot Twitter Stocks</h2>
      ...
      <Box display='flex' className='headerBox'>
        ...
        >
          ...
          />
          <TwitterSortDropdown changeSort={(sort) => setSort(sort)} />
        </Box>
      </Box>
        ...
        <Table className={classes.table} aria-label='customized table'>
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell align='right'>Total Likes&nbsp;</StyledTableCell>
